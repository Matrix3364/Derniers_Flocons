...
#il faut faire pip install streamlit-folium
...
if st.session_state.active_tab == ":derelict_house_building: Accueil":
    ...
    container_accueil2.markdown("Projet réalisé en juin 2025.")
...
"""
    ...
    with colAbout2:
        ...
        containerAboutImg.image("image1.png", use_container_width=True)
        containerAboutImg2 = st.container(border=True)
        containerAboutImg2.image("image2.png", use_container_width=True)
        containerAboutImg3 = st.container(border=True)
        containerAboutImg3.image("image3.png", use_container_width=True)
